        ...
        <div className="max-w-7xl mx-auto px-4 pt-3 pb-2 space-y-2">
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              ...
              <button
                onClick={() => googleLogin()}
                className="shrink-0 flex items-center gap-1.5 px-3 py-2 bg-white hover:bg-zinc-100 text-zinc-900 text-xs font-semibold rounded-xl transition-all shadow-md"
              >
